<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
      <a href="/" class="app-brand-link">
        ...
        <span class="app-brand-text demo menu-text fw-bolder ms-2">No Limit Gym</span>
      </a>
    ...
    <ul class="menu-inner py-1">
      ...
      <li class="menu-item {{ Request::is('membership_dashboard*') ? 'active' : '' }}">
        <a href="/membership_dashboard" class="menu-link">
